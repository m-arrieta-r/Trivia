...
class mod_trivia_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('static', 'label1', 'triviasetting1', 'Your trivia fields go here. Replace me!');

        $mform->addElement('header', 'triviafieldset', get_string('triviafieldset', 'trivia'));
        $mform->addElement('static', 'label2', 'triviasetting2', 'Your trivia fields go here. Replace me!');
